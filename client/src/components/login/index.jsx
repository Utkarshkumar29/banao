...
import { ErrorMessage, Form, FormHeading, Input, LoginLink, StyledButton } from "../../styles/register";
...
const Login=()=>{
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://banao-hjcv.onrender.com/login', { email, password })
            ...
            <LoginWrapper>
                <Form onSubmit={handleSubmit}>
                    ...
                    <LoginLink>
                        ...
                        <Link to='/' style={{textDecoration:"none"}}><p>Click Here</p></Link>
                    </LoginLink>
                </Form>
            </LoginWrapper>
        </LoginContainer>
